...
#python3 -u ./train.py experiment=pretrain task_name=pretrain > ./logfile/pretrain/to1d640_de5/not128/mel/train_fix_inst259.log
python3 -u ./train.py experiment=triplet_with_unet/y task_name=triplet_with_unet > ./logfile/triplet_with_unet/to1d640_de5/unet=0_triplet=1_recog=0/mel/train_fix_pretrain_no_norm.log
#python3 -u ./train.py experiment=triplet_with_unet/x > ./logfile/triplet_with_unet/to1d640_de5/unet=0_triplet=1_recog=0/mel/train.log
