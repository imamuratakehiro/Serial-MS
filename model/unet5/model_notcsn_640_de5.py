"""640次元を条件付けせずにDecode。Decoderは5つ。目的は同じエンコーダ特徴量から5つ分離できることを確かめること。"""
...
class UNetnotcsnde5(nn.Module):
    ...
    def forward(self, input):
        ...
        for idx, inst in enumerate(self.inst_list):
            decoder_out = decoder[inst].forward(conv6_out, conv5_out, conv4_out, conv3_out, conv2_out, conv1_out, input)
