...
class UNetForTriplet640De5(nn.Module):
    def __init__(self, inst_list, mono=True):
        super().__init__()
        if mono:
            encoder_in_size = 1
        else:
        ...
        # Encoder
        self.encoder = UNetEncoder(encoder_in_size=encoder_in_size, encoder_out_size=encoder_out_size)
