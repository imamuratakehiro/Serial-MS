...
class conv2d_bn(nn.Module):
    def __init__(self, filters, num_row, num_col, padding='same', strides=(1, 1), activation='relu', name=None, bias=False):
        ...
        self.conv2D = nn.Conv2d(filters, (num_row, num_col), strides=strides, padding=padding, use_bias=bias)
        self.batchNorm = nn.BatchNorm2d(axis=3, scale=False)
...
class MultiResBlock(nn.Module):
    def __init__(self, U, alpha = 1.72):
