...
class UNetForTriplet_to1d640_1dde5(nn.Module):
    ...
    def forward(self, input):
        ...
        for idx, inst in enumerate(self.inst_list):
            ...
            output_decoder[inst] = decoder[inst].forward(sep_feature_decoder, conv5_out, conv4_out, conv3_out, conv2_out, conv1_out, input)
            # probability
